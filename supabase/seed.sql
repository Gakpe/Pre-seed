...
Gouvernement en retard (> 6 semaines) : l''assurance défaut de crédit s''active. Coupons inchangés.

PME sous-performante sur son contrat : le performance bond couvre jusqu''aux 20 % engagés. Coupons inchangés.

Défaut de la PME : assurance défaut de crédit et paiement direct du ministère (lettres d''engagement). Principal protégé.
...
Dépréciation du ZMW face à l''EUR, swap de change avec Zanaco.'),
  ...
  ('scenarios-sortie', 'Scénarios de sortie', null, false, 'Documents clés', 83, 2, 'Deux familles de sorties identifiées. Document de travail, à affiner avec l''équipe.
...
update public.documents set content_en = 'Julien Gakpé, co-founder and CEO. Ex-Bpifrance, École Polytechnique, Avolta. Leads structuring and origination.
