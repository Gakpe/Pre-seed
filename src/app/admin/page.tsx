  ...
  return (
    <main className="mx-auto w-full max-w-5xl flex-1 px-6 py-10">
      ...
      <div className="mt-1 flex flex-wrap items-center justify-between gap-3">
        ...
        {/* Les mails types servent juste après un geste sur cette liste
            (validation, ouverture du niveau 2), d'où le raccourci ici. */}
        <Link
          href="/admin/emails"
          className="rounded-md border border-neutral-300 px-3 py-1.5 text-xs font-medium transition-colors hover:border-neutral-500"
        >
          Mails types
        </Link>
      </div>
